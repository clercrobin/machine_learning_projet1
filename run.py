	        ...
	        for lambda_ in np.logspace(-20,0,20):
	            ...
	            for gamma in np.logspace(-20,0,20):
	                ...
	                if new_accuracy>best:
	                    best=new_accuracy
	                    print("New best accuracy ! Accuracy : " + str(new_accuracy) +" Lambda : " +str(lambda_)+" Gamma : " +str(gamma) + " Degre : "+str(deg) + " Jet : " + str(i))
	                    mon_fichier.write("New best accuracy ! Accuracy : " + str(new_accuracy) +" Lambda : " +str(lambda_)+" Gamma : " +str(gamma) + " Degre : "+str(deg) + " Jet : " + str(i))
	                    best_lambda = lambda_
	                   	best_gamma = gamma
	                    best_degree = deg
	                else:
